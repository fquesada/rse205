$(document).ready(function() {
    ...
    //Boton Generar Reporte Basico
    $("#btn_generarcruce").click(function(event){
        event.preventDefault();        
    ...
    function datacruce(){
        var data = {};
        data['cooperativa'] = getcooperativa();
        data['ano'] = getanos();
        data['materia'] = getmateria();
        data['indsubmateria'] = $('#chbx_submaterias').is(':checked');       
        return data;
    }
    ...
    function getcooperativa(){
        var cooperativa = [];
        $("[name='chbxl_cooperativa[]']:checked").each(function() {
            cooperativa.push(this.value);
        });
        return cooperativa;
    }
    ...
    function getmateria(){
        var materia = [];
        $("[name='chbxl_materia[]']:checked").each(function() {
            materia.push(this.value);
        });
        return materia;
    }
