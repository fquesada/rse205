...
class Pregunta extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('idpregunta', 'required'),
			array('idpregunta, idsubeje, tipopregunta', 'numerical', 'integerOnly'=>true),
			array('pregunta', 'length', 'max'=>900),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('idpregunta, idsubeje, tipopregunta, pregunta', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('tipopregunta',$this->tipopregunta);
